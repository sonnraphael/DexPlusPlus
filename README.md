# Dex++
![Preview](https://raw.githubusercontent.com/sonnraphael/DexPlusPlus/main/preview.png)

Dex++ is an extended version of Moon's Dex, made to fulfill some Moon's Dex prophecy.

## Latest Version Script
```lua
loadstring(game:HttpGet("https://github.com/sonnraphael/DexPlusPlus/releases/latest/download/out.lua"))()
```
